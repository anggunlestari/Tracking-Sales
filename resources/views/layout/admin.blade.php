...
<head>
    ...
    <script src="{{ url('js/sweetalert2/sweetalert2.all.js') }}"></script>
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'dashboard') }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'kategori') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                {{-- <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover"> --}}
                                <a href="/admin/kategori/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'areaLokasi') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                {{-- <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover"> --}}
                                <a href="/admin/areaLokasi/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">Area Lokasi</span>
                                </a>
                            </li>
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'manajer') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/admin/manajer/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">Manajer</span>
                                </a>
                            </li>
                            <li class="menu-item  {{ App\Utilities\Helpers::requestAside('admin', 'sales') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/admin/sales/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'merchant') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/admin/merchant/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'table') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/admin/aktivitas/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">Aktivitas Sales</span>
                                </a>
                            </li>
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('admin', 'laporan') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/admin/laporan/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">Laporan Sales</span>
                                </a>
                            </li>
                        </ul>
                        <!--end::Menu Nav-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    @if (Auth::user()->foto)
                        <div class="symbol-label"><img src="{{ asset('storage/admin/' . Auth::user()->foto) }}"
                                alt="" width="85"></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        <a href="admin/ubahProfil/{{ Auth::user()->id }}"
