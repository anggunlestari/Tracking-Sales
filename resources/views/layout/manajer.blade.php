            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('manajer', 'dashboard') }}"
                                aria-haspopup="true">
                                <a href="/manajer/dashboard" class="menu-link">
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('manajer', 'sales') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/manajer/sales/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('manajer', 'merchant') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/manajer/merchant/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('manajer', 'aktivitas') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/manajer/aktivitas/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                            ...
                            <li class="menu-item {{ App\Utilities\Helpers::requestAside('manajer', 'laporan') }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/manajer/laporan/table" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    @if (Auth::user()->foto)
                        <div class="symbol-label"><img src="{{ asset('storage/manajer/' . Auth::user()->foto) }}"
                                alt="" width="85"></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        <a href="/manajer/ubahProfil/{{ Auth::user()->id }}"
