...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form method="post" action="/manajer/merchant/table" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <input class="form-control @error('manajer_id') is-invalid @enderror" type="hidden" id="manajer_id"
                        name="manajer_id" value="{{ auth()->user()->id }}" />
                    @error('manajer_id')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            jQuery('select[name="province_id"]').on('change', function() {
                ...
                if (provinceID) {
                    jQuery.ajax({
                        url: '/manajer/merchant/addm/' + provinceID,
                        type: "GET",
                        dataType: "json",
            ...
            jQuery('select[name="city_id"]').on('change', function() {
                ...
                if (cityID) {
                    jQuery.ajax({
                        url: '/manajer/merchant/addm1/' + cityID,
                        type: "GET",
                        dataType: "json",
