    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::AddData-->
                <div class="my-3 ml-5">
                    <a href="/manajer/merchant/add" class="d-inline">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">Choose
                                an option:</li>
                            <li class="navi-item">
                                <a href="{{ route('exportExcelMerchantM') }}" class="navi-link">
                            ...
                            <li class="navi-item">
                                <a href="{{ route('exportPdfMerchantM') }}" class="navi-link">
                                    <span class="navi-icon">
