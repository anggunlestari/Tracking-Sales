    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Tabel Laporan Statistik Sales
                    <span class="d-block text-muted pt-2 font-size-sm">Tabel Laporan Statistik Sales</span>
                </h3>
            </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">Choose
                                an option:</li>
                            <li class="navi-item">
                                <a href="{{ route('exportExcelLaporanM') }}" class="navi-link">
                            ...
                            <li class="navi-item">
                                <a href="{{ route('exportPdfLaporanM') }}" class="navi-link">
                                    <span class="navi-icon">
