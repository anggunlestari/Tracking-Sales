...
@section('content')
    ...
    <div class="card card-custom gutter-b">
        ...
        {{-- cetak by date --}}
        {{-- @if (Request::is('admin/aktivitas/table')) --}}
        @if (basename(url()->current()) == 'table')
                    ...
                    <div class="dropdown dropdown-inline mr-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href=""
                                        onclick="this.href='/manajer/exportDateExcelM/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value "
                                ...
                                <li class="navi-item">
                                    <a href=""
                                        onclick="this.href='/manajer/exportDatePdfM/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value "
                                        target="_blank" class=" navi-link">
                                        <span class="navi-icon">
...
@section('JS')
    ...
    <script>
        ...
        //display filter by date
        function updateStartDate(value) {
            var end_date = $('#tglakhir').val()
            var url = '{{ route('aktivitas.dataM') }}' + '?start_date=' + value + '&end_date=' + end_date
            table.ajax.url(url).load();
        }

        function updateEndDate(value) {
            var start_date = $('#tgkakhir').val()
            var url = '{{ route('aktivitas.dataM') }}' + '?start_date=' + start_date + '&end_date=' + value
            table.ajax.url(url).load();
        }
    </script>
@endsection
