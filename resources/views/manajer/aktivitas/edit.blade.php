...
@section('content')
    ...
    @foreach ($history as $value)
        <div class="card card-custom mb-7">
            ...
            <div class="card-body">
                <form method="post" action="/manajer/aktivitas/edit" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    ...
                    {{-- <fieldset disabled>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="nama_user" name="nama_user"
                                value="{{ $value->aktivitas->merchant->salesHasMerchant->userSales->nama_user ?? '' }}" />
                        </div>
                        <div class="form-group">
                            <label>Nama Merchant/Partner</label>
                            <input class="form-control" type="text" id="nama_merchant" name="nama_merchant"
                                value="{{ $value->aktivitas->merchant->nama_merchant }}" />
                        </div>
                    </fieldset> --}}
                    <div class="form-group">
                        <label>Tanggal</label>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-md-12 ml-30 text-center">
                ...
                <div class="forom-group my-5">
                    <button type="submit" class="btn btn-primary mr-2">Edit</button>
                    <a href="/manajer/aktivitas/table" class="btn btn-secondary">Batal</a>
                </div>
                </form>
                {{-- </div> --}}
            </div>
