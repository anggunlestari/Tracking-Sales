                    ...
                    <div class="dropdown dropdown-inline mr-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href=""
                                        onclick="this.href='/admin/exportDateExcel/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value "
                                ...
                                <li class="navi-item">
                                    <a href=""
                                        onclick="this.href='/admin/exportDatePdf/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value "
                                        target="_blank" class=" navi-link">
                                        <span class="navi-icon">
...
@section('JS')
    ...
    <script>
        ...
        function updateStartDate(value) {
            ...
            var url = '{{ route('aktivitas.data') }}' + '?start_date=' + value + '&end_date=' + end_date
            table.ajax.url(url).load();
        }

        function updateEndDate(value) {
            var start_date = $('#tgkakhir').val()
            var url = '{{ route('aktivitas.data') }}' + '?start_date=' + start_date + '&end_date=' + value
            table.ajax.url(url).load();
        }
    </script>
@endsection
