...
@section('content')
            ...
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                <thead>
                    <tr>
                        ...
                        <th title="Field #2">Nama Manajer</th>
    ...
    @foreach ($history as $value)
        <div class="card card-custom mb-7">
            ...
            <div class="card-body">
                <form method="post" action="/admin/aktivitas/edit" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    ...
                    {{-- <fieldset disabled>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="nama_user" name="nama_user"
                                value="{{ $history[0]->aktivitas->merchant->manajerHasMerchant->userManajer->nama_user ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label>Nama Sales</label>
                            <input class="form-control" type="text" id="nama_user" name="nama_user"
                                value="{{ $history[0]->aktivitas->merchant->salesHasMerchant->userSales->nama_user ?? '' }}" />
                        </div>
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-10 col-md-12 ml-30 text-center">
                <div class="forom-group mb-5">
                    ...
                    <a href="/admin/aktivitas/table" class="btn btn-secondary">Batal</a>
                </div>
                </form>
            </div>
        </div>
