    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Tabel Kategori
                    <span class="d-block text-muted pt-2 font-size-sm">Tabel Kategori</span>
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::AddData-->
                <div class="ml-5">
                    <a href="/admin/kategori/add" class="d-inline">
                        <button class="btn btn-primary">
                            <i class="far fa-plus-square"></i>Tambah Kategori</button>
                    </a>
                </div>
                <!--end::AddData-->
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">Choose
                                an option:</li>
                            <li class="navi-item">
                                <a href="{{ route('exportExcelKategori') }}" class="navi-link">
                            ...
                            <li class="navi-item">
                                <a href="{{ route('exportPdfKategori') }}" class="navi-link">
                                    <span class="navi-icon">
