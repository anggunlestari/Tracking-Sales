                ...
                <a href="/admin/manajer/table">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="text-dark font-weight-bolder font-size-h3">{{ $manajer }} Manajer</div>
                        </div>
                        <!--end::Stats-->
                    </div>
                    <!--end::Body-->
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            ...
                            <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                {{-- @php($i = 0) --}}
                                {{ \App\Utilities\Helpers::statusCountDash($aktivitas, 1) ?? '' }} Prospek
                            </div>
                        </div>
                        <!--end::Stats-->
                        <!--begin::Chart-->
                ...
                <a href="/admin/status/2">
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-danger font-weight-bold">Status Kunjungan</div>
                            <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                {{ \App\Utilities\Helpers::statusCountDash($aktivitas, 2) ?? '' }}
                                Presentasi/Demo
                            </div>
                        </div>
                        <!--end::Stats-->
                ...
                <a href="/admin/status/3">
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-danger font-weight-bold">Status Kunjungan</div>
                            <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                {{ \App\Utilities\Helpers::statusCountDash($aktivitas, 3) ?? '' }}
                                Closing Paid
                            </div>
                        </div>
                        <!--end::Stats-->
                ...
                <a href="/admin/status/4">
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-danger font-weight-bold">Status Kunjungan</div>
                            <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                {{ \App\Utilities\Helpers::statusCountDash($aktivitas, 4) ?? '' }} Pending
                            </div>
                        </div>
                        <!--end::Stats-->
                        <!--begin::Chart-->
                ...
                <a href="/admin/status/5">
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-danger font-weight-bold">Status Kunjungan</div>
                            <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                {{ \App\Utilities\Helpers::statusCountDash($aktivitas, 5) ?? '' }} Maintenance
                            </div>
                        </div>
                        <!--end::Stats-->
                        <!--begin::Chart-->
