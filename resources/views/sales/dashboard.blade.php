...
@section('content')
    ...
    <div class="card text-center mb-10">
        <div class="card-header">
            <h1>Selamat Datang di Halaman Sales</h1>
        </div>
    </div>
