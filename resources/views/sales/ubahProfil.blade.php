...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form method="post" action="/sales/{{ $user->id }}/ubahProfil" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="card-body">
                ...
                <div class="forom-group mt-7">
                    ...
                    <a href="/sales/dashboard" class="btn btn-secondary">Batal</a>
                </div>
            </div>
        </form>
        <!--end::Form-->
